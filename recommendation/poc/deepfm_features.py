...
# 전체 알러지 마스터 코드 (실제로는 allergen_master_list.xlsx 120개 전체를 사용.
# 여기서는 데모용으로 더미 데이터에 등장하는 것들만 축약)
ALLERGEN_VOCAB = ["chicken", "beef", "duck", "salmon", "tuna", "corn"]
...
def build_pet_features(pet: dict) -> dict:
    ...
    return {
        ...
        "multi_hot": {
            "allergy_codes": allergy_multi_hot,  # ALLERGEN_VOCAB 순서와 매칭
        },
    }
